...
export class DefaultRegistry<TTaskFunction extends Function = Function> {
  protected _tasks = new Map<string, TTaskFunction>()
   ...
   */
  set(name: string, fn: TTaskFunction): TTaskFunction {
   ...
   */
  tasks(): { [taskName: string]: TTaskFunction } {
