...
expectType<FirstChunkStream>(
  new FirstChunkStream({ chunkSize: 7 }, async () => FirstChunkStream.stop)
)
expectType<FirstChunkStream>(new FirstChunkStream({ chunkSize: 7 }, async () => ""))
expectType<FirstChunkStream>(
  new FirstChunkStream({ chunkSize: 7 }, async () => Buffer.from(""))
)
expectType<FirstChunkStream>(new FirstChunkStream({ chunkSize: 7 }, async () => "string"))
expectType<FirstChunkStream>(
  new FirstChunkStream({ chunkSize: 7 }, async () => new Uint8Array(0))
)
expectType<FirstChunkStream>(
  new FirstChunkStream({ chunkSize: 7 }, async () => {
