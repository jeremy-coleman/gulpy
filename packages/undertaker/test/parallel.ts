import { Undertaker, Done } from "../mod"
...
describe("parallel", () => {
  ...
  it("should throw on non-valid tasks combined with valid tasks", done => {
    function fail() {
      taker.parallel("test1", "test2", "test3", {} as invalid)
    }
  ...
  it("should take only one array of registered tasks", done => {
    taker.parallel(["test1", "test2", "test3"])((err, results) => {
  ...
  it("should take nested parallel", done => {
