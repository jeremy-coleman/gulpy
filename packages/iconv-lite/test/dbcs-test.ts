...
function convertWithDefault(converter, buf) {
  ...
  return Buffer.from(exports.defaultCharSingleByte)
}
...
describe("Full DBCS encoding tests", function () {
  ...
  for (const enc in exports.encodings) {
    if (exports.encodings[enc].type === "_dbcs")
      (enc => {
        // Create tests for this encoding.
        it(`Decode DBCS encoding '${enc}'`, () => {
          ...
          const errors = []
          forAllChars(converter.convert.bind(converter), (valid, inp, outp) => {
            const strActual = exports.decode(inp, enc)
        ...
        it(`Encode DBCS encoding '${enc}'`, () => {
          ...
          for (let i = 0; i < 0x10000; i++) {
            ...
            const bufActual = exports.encode(str, enc)
            ...
            const str1 = exports.decode(bufExpected, enc)
            const str12 = exports.decode(bufActual, enc)
