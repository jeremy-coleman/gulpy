...
test('\nresolving a "/*# sourceMappingURL=map-file-comment.css.map*/" style comment inside a given css content', t => {
  ...
  t.deepEqual(
    sm.sources,
    ["./client/sass/core.scss", "./client/sass/main.scss"],
...
test('\nresolving a "//# sourceMappingURL=map-file-comment.css.map" style comment inside a given css content', t => {
  const css = fs.readFileSync(
    `${__dirname}/fixtures/map-file-comment-double-slash.css`,
    "utf8"
  )
  const conv = convert.fromMapFileSource(css, `${__dirname}/fixtures`)
  const sm = conv.toObject()
...
test("\nresolving a /*# sourceMappingURL=data:application/json;base64,... */ style comment inside a given css content", t => {
