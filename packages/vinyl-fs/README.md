...
Last upstream commit: [df245a4 17 May 2020](https://github.com/gulpjs/vinyl-fs/commit/df245a40f5dbe37ca620ee71f1a7930cfccb5e42).
...
vfs.src(["./js/**/*.js", "!./js/vendor/*.js"]).pipe(map(log)).pipe(vfs.dest("./output"))
```
